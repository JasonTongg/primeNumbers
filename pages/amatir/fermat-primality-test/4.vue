  ...
  <div class="materi-container">
    <div class="content-container">
      ...
      <div class="content-body">
        ...
        <div class="content">
          <p>
            Tetapi jika persamaan terpenuhi dan rupanya p adalah bukan bilangan
            prima maka a dinyatakan sebagai ferma liar
          </p>
        </div>
      </div>
    </div>
...
let next = () => {
  if (right.value.classList.contains("active"))
    router.push("/amatir/fermat-primality-test/5");
};
