    ...
    <div class="content-container">
      ...
      <div class="content-body">
        ...
        <div class="content">
          <p>FPB(14,9) = 1</p>
          <p>
            Faktor 14 = 1,2,7 dan 12 <br />
            Faktor 9 = 1,3 dan 9
          </p>
          <p>Jadi 14 dan 9 adalah relatif prima</p>
        </div>
      </div>
      <div class="popup-backdrop" v-if="showPopup">
        <div class="popup-content">
          ...
          <div class="buttons">
            ...
            <NuxtLink to="/amatir/kongruensi/1">Berikutnya</NuxtLink>
          </div>
        </div>
      </div>
    </div>
...
let data = amatirModule.value.materi[1];

console.log(store);
store.updateAmatirModule(2, 1);
store.showSection("amatir", 2, true);

let prev = () => {
  router.push("/amatir/relatif-prima/1");
};
let next = () => {
