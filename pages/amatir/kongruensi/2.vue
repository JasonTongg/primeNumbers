  ...
  <div class="materi-container">
    <div class="content-container">
      ...
      <div class="content-body">
        ...
        <div class="content">
          <p>
            Kongruen modulo digunakan untuk menunjukkan hubungan antara semua
            bilangan bulat yang menyisakan sisa yang sama jika dibagi dengan
...
if (data.progress !== data.end) {
  store.updateAmatirModule(2, 2);
}

let prev = () => {
  router.push("/amatir/kongruensi/1");
};
let next = () => {
  if (right.value.classList.contains("active"))
    router.push("/amatir/kongruensi/3");
};
