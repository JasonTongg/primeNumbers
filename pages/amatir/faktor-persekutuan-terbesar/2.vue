  ...
  <div class="materi-container">
    <div class="content-container">
      ...
      <div class="content-body">
        ...
        <div class="content">
          <p>
            Misalnya, untuk mencari FPB dari 12 dan 18, kita dapat mencari
            faktor dari masing-masing bilangan terlebih dahulu
          </p>
          <p>
            Faktor 12 = 1,2,3,4,6, dan 12 <br />
...
if (data.progress !== data.end) {
  store.updateAmatirModule(2, 0);
}

let prev = () => {
  router.push("/amatir/faktor-persekutuan-terbesar/1");
};
let next = () => {
  if (right.value.classList.contains("active"))
    router.push("/amatir/faktor-persekutuan-terbesar/3");
};
