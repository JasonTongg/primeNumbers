      ...
      <div class="popup-backdrop" v-if="showPopup">
        <div class="popup-content">
          ...
          <div class="buttons">
            ...
            <NuxtLink to="/amatir/relatif-prima/1">Berikutnya</NuxtLink>
          </div>
        </div>
      </div>
    </div>
...
console.log(store);
store.updateAmatirModule(3, 0);
store.showSection("amatir", 1, true);

let prev = () => {
  router.push("/pemula/faktor-persekutuan-terbesar/2");
};
let next = () => {
