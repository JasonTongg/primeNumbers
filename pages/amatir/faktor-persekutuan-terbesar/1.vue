  ...
  <div class="materi-container">
    <div class="content-container">
      ...
      <div class="content-body">
        ...
        <div class="content">
          <p>
            Faktor persekutuan terbesar (FPB) adalah faktor terbesar yang sama
            dari dua bilangan.
          </p>
          <p>
            FPB dapat ditemukan dengan cara mencari faktor terbesar yang sama
            dari dua bilangan
          </p>
        </div>
      </div>
...
store.sideActive = [false, false, true, false, false];
store.showSideButton = true;
store.showSide = true;

if (data.progress !== data.end) {
  store.updateAmatirModule(1, 0);
}

let next = () => {
  if (right.value.classList.contains("active"))
    router.push("/amatir/faktor-persekutuan-terbesar/2");
};
