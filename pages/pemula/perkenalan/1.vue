  ...
  <div class="materi-container">
    <div class="content-container">
      ...
      <div class="content-body">
        ...
        <div class="content">
          <p style="text-align: center">Mencari Bilangan Prima</p>
          <img src="../../../assets/pemula-quiz-1.jpeg" alt="" />
          <p style="text-align: center">
            Pada bagian berikutnya akan diminta untuk mencari/menentukan
            bilangan prima dari 6 pilihan angka.
          </p>
        </div>
      </div>
    </div>
...
if (data.progress !== data.end) {
  store.updateQuizModule("pemula", 1, 0);
}
